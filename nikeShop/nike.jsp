...
<body>	
	...
	<div class="sectionNikeOne">
		<div align="center" class="nikeShopHeadline"><h2 class="nikeHeadline"><font color="  #380000  " >NIKE商店专区</font></h2></div>
		<h2 class="nikeH2"><font color="  #380000   ">挑选一双耐克篮球鞋去扣篮吧!!</font></h2>
		<div class="container">
		<!--用form表单使用户可以选择价格-->
		<form action="nike.jsp">
		...
		<!--用for循环的方式将数据库资料表nike中的信息全部取出-->
			...
			rs = stmt.executeQuery("Select * from nike ");
			rs.last();
			...
			<div class="row">
				...
				<div class="col-lg-4 nikeShoeSingle">
				
					<div class="row">
						<div class="col-lg-12"><img src='img/<%=rs.getString("nikeShoeImg")%>' alt='<%=rs.getString("nikeShoeId")%>' width="222" height="222"></div>
					</div>
					<div class="row">
						<div class="col-lg-1"></div>
						<div class="col-lg-5"><font color="#800000" size="6px"><%=rs.getString("nikeShoePrice")%> TWD</font></div>
						<!--用tag a 传参数到nikeShoeConcreteInformation,参数包括单价，剩余量，图片信息-->
						<div class="col-lg-1"><a href="nikeShoeConcreteInformation.jsp?nikeShoePrice=<%=rs.getString("nikeShoePrice")%>&nikeShoeImg=<%=rs.getString("nikeShoeImg")%>&nikeShoeQuantity=<%=rs.getString("nikeShoeQuantity")%>"><button type="button" >购买</button></div></a>
						<div class="col-lg-1"><a href="commentNike/comment.jsp?nikeShoeId=<%=rs.getString("nikeShoeId")%>"><font color="#800000"><button>评论</button></font></a></div>
						<div class="col-lg-1"></div>
				...
				rs.next();
				%>
				<div class="col-lg-4 nikeShoeDouble">
					<div class="row">
						<div class="col-lg-12"><img src='img/<%=rs.getString("nikeShoeImg")%>' alt='<%=rs.getString("nikeShoeId")%>' width="222" height="222"></div>
					</div>
			...
			rs = stmt.executeQuery("Select * from nike where nikeShoePrice between 0 and "+price+" ");
			rs.last();
			int rowCount = rs.getRow();
			rs.beforeFirst();
