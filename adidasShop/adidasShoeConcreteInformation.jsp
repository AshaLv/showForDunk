...
<body>	
		...
		<div class="container">
			<div class="row" >
				...
				<div class="col-lg-5">
					...
					<div class="row">
						<font color="#008000">
						<form action="payAdidas.jsp" method="post" name="shoePay">
	...
	<script language = javascript> 
					...
					var adidasShoePrice=request('adidasShoePrice'); 
					var adidasShoeImg=request('adidasShoeImg'); 
					var adidasShoeQuantity=request('adidasShoeQuantity');
					
					
					document.getElementById("shoeInfoImg").src = "img/"+adidasShoeImg;
					document.getElementById("shoeInfoImgTo").value = adidasShoeImg;
					document.getElementById("shoeInfoPrice").innerHTML = "鞋子单价:    "+adidasShoePrice;
					document.getElementById("shoeInfoQuantityShow").innerHTML = "库存剩余："+adidasShoeQuantity;
					document.getElementById("shoeInfoPriceHidden").value = adidasShoePrice;
