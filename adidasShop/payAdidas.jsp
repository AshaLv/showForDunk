...
<body>	
	...
	%>
			<div align="center"><form action="../orderInformation/orderInformation.jsp" >
	...
	<%
		...
		//如果是购物车SUBMIT导向到这个网页的话，那么就要记录下鞋子的有关信息到SESSION，这个时候要用到数组
			...
			out.println("<script language='javascript'>window.alert('成功加入购物车，继续你的购物之旅');window.location.href='adidas.jsp';</script>");
	}	//如果有人直接登入支付网址，则使用户回到购买页
		else{
			out.println("<script language='javascript'>window.alert('您好像并没有挑选商品哦');window.location.href='adidas.jsp';</script>");
	}
	%>